...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // layer for window management(by rectangle)
    [2] = LAYOUT(
        KC_NO   , KC_NO                  , KC_NO                  , KC_NO                  , LCTL(LALT(KC_MINS)) , LCTL(LALT(KC_EQL)) , KC_NO   , KC_NO                     , LGUI(LSFT(KC_RBRC))       , LGUI(LSFT(KC_LBRC))        , KC_NO                      , KC_NO , KC_NO  , KC_NO , KC_NO , // 15
        ...
        KC_NO   , LCTL(LALT(KC_D))       , LCTL(LALT(KC_T))       , LSFT(LALT(LCMD(KC_D))) , LALT(LCMD(KC_G))    , KC_NO              , KC_NO   , LCTL(LALT(LSFT(KC_DOWN))) , LCTL(LALT(LSFT(KC_DOWN))) , LCTL(LALT(LSFT(KC_RIGHT))) , LCTL(LALT(LSFT(KC_RIGHT))) , KC_NO , KC_NO  , KC_NO , KC_NO , // 15
        KC_LSFT , LCTL(LALT(LGUI(KC_D))) , LCTL(LALT(LGUI(KC_T))) , LALT(LCMD(KC_D))       , KC_NO               , KC_NO              , KC_TRNS , LALT(LGUI(KC_LEFT))       , LALT(LGUI(KC_DOWN))       , LALT(LGUI(KC_UP))          , LALT(LGUI(KC_RIGHT))       , KC_NO , KC_NO  , KC_NO , // 14
