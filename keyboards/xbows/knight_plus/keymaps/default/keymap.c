...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT(
            ...
            KC_NO, LCTL(LALT(KC_D)) , LCTL(LALT(KC_T)) , LALT(LCMD(KC_D))       , LALT(LCMD(KC_G)) , KC_NO , KC_NO , LALT(LGUI(KC_LEFT))       , LALT(LGUI(KC_DOWN))       , LALT(LGUI(KC_UP))          , LALT(LGUI(KC_RIGHT)) , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , LCTL(LALT(LCMD(KC_C))) , KC_NO            , KC_NO , KC_NO , KC_NO                     , LCTL(LALT(LSFT(KC_DOWN))) , LCTL(LALT(LSFT(KC_RIGHT))) , KC_NO                , KC_NO , KC_NO , KC_NO ,
